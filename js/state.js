...
function makeHarmony(overrides = {}) {
  ...
  const h = {
    ...
    labelAllOctaves: overrides.labelAllOctaves !== undefined ? overrides.labelAllOctaves : false,
    labelFontSize: overrides.labelFontSize || 10,
    ...
    connectTones: overrides.connectTones !== undefined ? overrides.connectTones : false,
...
function snapshotHarmony(h) {
  return {
    ...
    showLabels: h.showLabels, labelAllOctaves: h.labelAllOctaves || false,
    ...
    labelAllOctaves2: h.labelAllOctaves2 || false,
