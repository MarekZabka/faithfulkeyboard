...
function makeHarmony(overrides = {}) {
  ...
  const h = {
    ...
    keyStrokeWidth: overrides.keyStrokeWidth !== undefined ? overrides.keyStrokeWidth : 1.5,
...
function snapshotHarmony(h) {
  return {
    ...
    keyRounding: h.keyRounding || 0, keyEdge: h.keyEdge || 'straight', keyBulge: h.keyBulge !== undefined ? h.keyBulge : 0.2, keyStrokeWidth: h.keyStrokeWidth !== undefined ? h.keyStrokeWidth : 1.5,
